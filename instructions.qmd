...
`all-in-one-app.sh`-Script (See Section 5).
...
#### 5. Run dockerized apps via the `all-in-one-app.sh` Script
...
- Pull Pandora Docker images
- Start Pandora Docker containers
- Stop running Pandora Docker containers
...
4. Run the script
   ...
   run with sudo if your user isn't in the docker group.
